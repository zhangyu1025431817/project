...
package com.buyiren.app.network.http.proxy;

import android.text.TextUtils;
import android.util.Log;
import android.widget.Toast;

import com.buyiren.app.MyApplication;
import com.buyiren.app.network.http.GlobalToken;
import com.buyiren.app.network.http.RetrofitUtil;
import com.buyiren.app.network.http.api.IApiService;
import com.buyiren.app.network.http.api.TokenModel;
import com.buyiren.app.network.http.exception.TokenInvalidException;
import com.buyiren.app.network.http.exception.TokenNotExistException;
                ...
                return observable.flatMap(new Func1<Throwable, Observable<?>>() {
                    ...
                    public Observable<?> call(Throwable throwable) {
                        if (throwable instanceof TokenInvalidException) {
                            ...
                            Toast.makeText(MyApplication.getContext(), "Token is not existed!!", Toast.LENGTH_SHORT).show();
