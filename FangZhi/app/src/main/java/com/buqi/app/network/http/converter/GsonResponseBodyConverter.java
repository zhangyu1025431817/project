...
package com.buqi.app.network.http.converter;

import com.buqi.app.network.http.api.ApiModel;
import com.buqi.app.network.http.api.ErrorCode;
import com.buqi.app.network.http.exception.DeviceException;
import com.buqi.app.network.http.exception.TimeException;
import com.buqi.app.network.http.exception.TokenInvalidException;
import com.buqi.app.network.http.exception.UserInvalidException;
import com.buqi.app.network.http.exception.UserPasswordException;
